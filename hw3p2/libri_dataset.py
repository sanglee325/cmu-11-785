...
class LibriSamples(torch.utils.data.Dataset):
    ...
    def __init__(self, data_path="data", partition="train"): # You can use partition to specify train or dev
    ...
    def __getitem__(self, ind):
        ...
        Yy = np.asarray([self.PHONEMES.index(yy) for yy in Y[1:-1]]) # TODO: Convert sequence of  phonemes into sequence of Long tensors
